...
//        maColorHandle= GLES30.glGetAttribLocation(mProgram, "aColor");
        ...
        GLES30.glBindAttribLocation(mProgram,0,"aPosition");
        GLES30.glBindAttribLocation(mProgram,1,"aColor");
    }
    ...
    {        
       ...
       //启用顶点颜色数据数组
        ...
        GLES30.glDrawElements(GLES20.GL_TRIANGLES,iCount,GLES30.GL_UNSIGNED_BYTE,mIndexBuffer);
//        mIndexBuffer.position(start);
//        // 绘制图形
//        GLES30.glDrawRangeElements(GLES30.GL_TRIANGLES, 0 , 10 ,count,
