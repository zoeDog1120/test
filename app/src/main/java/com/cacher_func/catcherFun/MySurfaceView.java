...
import com.cacher_func.view.BNAbstractView;
import com.cacher_func.view.GameView;
import com.cacher_func.view.LoadView;
import com.cacher_func.view.MainView;
import com.cacher_func.view.MenuView;
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer 
    {
		...
		public void onSurfaceChanged(GL10 gl, int width, int height) 
		{
			...
			if(currView==null){
				...
				//创建音乐
				if(!musicOff){
					MyActivity.sound.playBackGroundMusic(activity, R.raw.nogame);
				}
			}
				currView=lv;
				lv=null;
