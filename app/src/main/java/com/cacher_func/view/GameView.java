...
import com.cacher_func.MatrixState.MatrixState2D;
import com.cacher_func.MatrixState.MatrixState3D;
import com.cacher_func.addRigidBody.BoxRigidBody;
import com.cacher_func.addRigidBody.Camera;
import com.cacher_func.addRigidBody.Car;
import com.cacher_func.addRigidBody.Claw;
import com.cacher_func.addRigidBody.Doll;
import com.cacher_func.addRigidBody.Niu;
import com.cacher_func.addRigidBody.Parrot;
import com.cacher_func.addRigidBody.Phone;
import com.cacher_func.addRigidBody.Robot;
import com.cacher_func.addRigidBody.Tv;
import com.cacher_func.catcherFun.MyActivity;
import com.cacher_func.catcherFun.MySurfaceView;
import com.cacher_func.constant.Constant;
import com.cacher_func.constant.SourceConstant;
import com.cacher_func.object.BN2DObject;
import com.cacher_func.object.TexFloor;
import com.cacher_func.thread.HoleThread;
import com.cacher_func.thread.KeyThread;
import com.cacher_func.thread.MoneyThread;
import com.cacher_func.thread.PhysicsThread;
import com.cacher_func.util.DrawNumber;
import com.cacher_func.util.RigidBodyHelper;
import com.cacher_func.util.SliderHelper;
import com.cacher_func.util.manager.ShaderManager;
import com.cacher_func.util.manager.TextureManager;
...
public class GameView extends BNAbstractView
{
    		...
    		if(!isMenu&&!isCollection&&!ismoneyout)
    		{
							...
							y>MGstart_TOUCH_TOP_y&&y<MGstart_TOUCH_BOTTOM_y&&!isGrab&&!gamestart)
		    		{
		    			...
		    			}else
		    			{
							...
							MyActivity. editor.putString("count", Integer.toString(moneycount));
    ...
    public void OneMoney()
    {
    	if(dance<70){//点击开始按钮后掉落一个金币
			...
			if(dance==62){
				if(!effictOff){
					MyActivity.sound.playMusic(SOUND_DropMoney,0);
    			}
			}
