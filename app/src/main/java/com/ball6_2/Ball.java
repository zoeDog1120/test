...
import static com.ball6_2.Constant.*;
...
public class Ball {
	...
	int maNormalHandle;//法向量引用
	int maLightLocationHandle;//光源位置引用
	int maCameraHandle;//摄像机位置引用
	...
	public void initShader(MySurfaceView mv) {
		...
		maCameraHandle = GLES30.glGetUniformLocation(mProgram,"aCamera");
