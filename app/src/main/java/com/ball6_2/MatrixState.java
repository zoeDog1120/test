...
{  
    ...
    public static FloatBuffer lightPositionFB ;//光源位置的缓冲
    public static FloatBuffer lightDirectionFB;//光源方向缓冲
    static ByteBuffer llbbL = ByteBuffer.allocateDirect(3*4);//待用的字节缓冲
